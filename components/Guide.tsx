...
const Guide = () => {
  return (
    <section className="flexCenter flex-col">
      ...
      <div className="flexCenter max-container relative w-full border-2 border-blur-500">
        <Image 
          src="/boat.png"
          alt="boat"
          width={1440}
          ...
          />
           <div className="flexBetween flex-col">
            <div className='flex w-full flex-col'>
              ...
              <p className="bold-20 mt-2">Pawna Dam</p>
            </div>

            <div className='flex w-full flex-col'>
              <p className="regular-16 text-gray-20">Start track</p>
              <h4 className="bold-20 mt-2 whitespace-nowrap">Pune Station</h4>
            </div>
          </div>
        </div>
      </div>
